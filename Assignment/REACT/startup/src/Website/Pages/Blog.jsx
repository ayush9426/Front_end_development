                                                ...
                                                <div className="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                                                    <div className="blog-item bg-light rounded overflow-hidden">
                                                        ...
                                                        <div className="p-4">
                                                            ...
                                                            <p>{data.desc}</p>
                                                            <button onClick={forward} className="btn text-uppercase" data-bs-toggle="modal" data-bs-target="#exampleModal" href>Read More <i className="bi bi-arrow-right" /></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            )
