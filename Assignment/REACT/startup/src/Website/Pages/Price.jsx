                        ...
                        <div className="row g-2">
                            
                                {
                                    price && price.map((data, index) => {
                                        const { Plan, price, includes } = data
                                        return (
                                            <div className="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                                            <div className="bg-light rounded">
                                                <div className="border-bottom py-4 px-5 mb-4">
                                                    <h4 className="text-primary mb-1">{Plan}</h4>
                                                    <small className="text-uppercase">For Small Size Business</small>
                                                </div>
                                                <div className="p-5 pt-0">
                                                    <h1 className="display-5 mb-3">
                                                    <small className="align-top" style={{ fontSize: 26 }}>{price}</small>
                                                    </h1>
                                                    <div className="d-flex justify-content-between mb-3"><span style={{ fontSize: 20}}>{includes}</span><i className="fa fa-check text-primary pt-1" /></div>
