                                ...
                                <div className="row gx-5">
                                    ...
                                    <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                                        ...
                                        <div className="link-animated d-flex flex-column justify-content-start">
                                            ...
                                            <Link className="text-light mb-2"  to="/team"><i className="bi bi-arrow-right text-primary me-2" />Meet The Team</Link>
                                            <Link className="text-light mb-2" to="/blogg"><i className="bi bi-arrow-right text-primary me-2" />Latest Blog</Link>
