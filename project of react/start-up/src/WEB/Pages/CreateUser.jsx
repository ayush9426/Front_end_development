...
function CreateUser() {
    ...
    const submitdata = async (e) => {
        ...
        try {
            ...
            toast.error("api not match/found")
                                ...
                                <form onSubmit={submitdata}>
                                    <div className="row gy-3 gy-md-4 overflow-hidden">
                                        <div className="col-12">
                                            ...
                                            <input type="text" onChange={getchange} value={newdata.name} className="form-control" name="name" id="firstName" placeholder="First Name" required />
                                        </div>

                                        <div className="col-12">
                                            <label htmlFor="email" className="form-label">Email <span className="text-danger">*</span></label>
                                            <input type="email" onChange={getchange} value={newdata.email} className="form-control" name="email" id="email" placeholder="name@example.com" required />
                                        </div>
                                        <div className="col-12">
                                            <label htmlFor="password" className="form-label">Password <span className="text-danger">*</span></label>
                                            <input type="password" onChange={getchange} value={newdata.password} className="form-control" name="password" id="password" placeholder='your password' required />
                                        </div>
