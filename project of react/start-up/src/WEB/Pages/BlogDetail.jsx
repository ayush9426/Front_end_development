...
function BlogDetail() {
    ...
    return (
        <div>
            <Header2 title="Blog Details" data="Blog Details" />
            <div>
                {/* Blog Start */}
                            ...
                            <div className="col-lg-8">
                                {/* Blog Detail Start */}
                                {
                                    detail && detail.map((data,index)=>{
                                        return(
                                            <div className="mb-5">
                                    <img className="img-fluid w-100 rounded mb-5" src={data.img} alt />
                                    <h1 className="mb-4">{data.title}</h1>
                                    <p>{data.desc} <br /><br />Sadipscing labore amet rebum est et justo gubergren. Et eirmod ipsum sit diam ut
