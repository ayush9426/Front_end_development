...
function Price() {
  ...
  return (
    <div>
      <Header2 title="Pricing Plan" data="Pricing Plan" />
      <div>
        {/* Pricing Plan Start */}
            ...
            <div className="row g-3">
              
                {
                  ...
                  <div className="border-bottom py-4 px-5 mb-4">
                    <h4 className="text-primary mb-1">{data.Plan}</h4>
                    <small className="text-uppercase">For Small Size Business</small>
                  </div>
                  <div className="p-5 pt-0">
                    <h1 className="display-5 mb-3">
                      <small className="align-top" style={{ fontSize: 24, }}>{data.price}</small>
                    </h1>
                    <div className="d-flex justify-content-between mb-2">{data.includes}<i className="fa fa-check text-primary pt-1" /></div>
