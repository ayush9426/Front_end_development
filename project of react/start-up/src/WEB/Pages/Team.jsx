...
function Team() {
  ...
  return (
    <div>
      <Header2 title="Our Team" data="Team" />
      <div>
        {/* Team Start */}
            ...
            <div className="row g-5">
              {
                team && team.map((data,index)=>{
                  return(
                    <div height="200px" className="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                <div className="team-item bg-light rounded overflow-hidden">
                  ...
                  <div className="text-center py-4">
                    ...
                    <p className="text-uppercase m-0">{data.position}</p>
                    <p className="text-uppercase m-0">{data.department}</p>
                  </div>
                </div>
              </div>
                  )
