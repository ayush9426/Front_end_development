...
function AdminLogin() {
    ...
    const submit = async(e)=>{
        ...
        try {
            const res =await axios.get(`http://localhost:3000/admin?email=${register.email}`)
            ...
            if(admin.password !== register.password){
            ...
            toast.error("Data Does Not Matched..!!")
        }
    }
                                        ...
                                        <div className="row gy-2 overflow-hidden">
                                            <div className="col-12">
                                                <div className="form-floating mb-3">
                                                    <input value={register.email} onChange={getchange} type="email" className="form-control" name="email" id="email" placeholder="name@example.com" required />
                                                    <label htmlFor="email" className="form-label">Email</label>
                                                </div>
                                            </div>
                                            <div className="col-12">
                                                <div className="form-floating mb-3">
                                                    <input value={register.password} onChange={getchange} type="password"  className="form-control" name="password" id="password" placeholder="Password" required />
